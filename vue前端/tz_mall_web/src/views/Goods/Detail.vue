		...
		<div class="goods">
			<div class="good clearfix">
				...
				<div class="good-content fl">
					...
					<a href="#" class="add-cart" @click="addcartData(goodsList.data.sku_id,num)">加入购物车</a>
				</div>
			</div>
			<div class="comment">
				<Comment :skuId='$route.params.skuId'></Comment>
			</div>
		</div>
	</div>
...
import {getDoodsDetail} from '@/network/goods'
...
import {addcartData} from '@/utils/goods'
	...
	onMounted(()=>{
		skuId.value = route.params.skuId
		getDoodsDetail(skuId.value).then(res=>{
